...
export default function Footer() {
  return (
    <footer className="flex flex-col bg-neutral-800 w-full p-8 justify-center items-center text-white md:bg-[url('/images/footer2.png')] bg-repeat md:bg-no-repeat md:bg-cover bg-center bg-gradient-to-b from-black/10 via-black/20 to-black/80">
