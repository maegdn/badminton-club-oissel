      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full pt-16 pb-12">
        ...
        <div className="flex flex-col md:flex-row flex-wrap justify-center items-center w-3/4 md:w-4/5 gap-8 my-12 text-justify ">
          <div className="flex w-full flex-col mb--30">
            ...
            <div className="relative bottom-24 left-80 border-3 border-black z-4 bg-white w-3/5">
              <h3 className="font-[HemiHead] bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700  px-4 py-2 text-white">
                Soirée à thème 🥳
              </h3>
              ...
              <p className="p-4 bg-white">
                ...
                moins une fois. Les victoires/défaites sont ensuite répertoriées
                pour faire un “classement”. Le nombre de participants peut être
                restreint selon le nombre de joueurs présents dans l’équipe
                adverse. A chaque rencontre un message sera envoyé sur le groupe
                whatsapp pour annoncer le niveau de l’équipe adverse.
              </p>
            </div>
          </div>
          ...
          <div className="flex w-full flex-col ">
            ...
            <div className="relative bottom-44 left-80 border-3 border-black z-4 bg-white w-3/5">
              ...
              <p className="p-4 bg-white">
                ...
                saison. Il est ouvert à tous les joueurs loisirs et les joueurs
                licenciés Non Classés.
              </p>
            </div>
          </div>
