...
/>
      ...
      <main className="flex flex-col w-full min-h-screen grow items-center">
        <div className="flex flex-col justify-start text-justify lg:w-3/4 px-10 py-10">
          ...
          <section className="mt-12 mb-6 justify-start text-start" aria-label="Conception du site">
            <h2 className="text-xl font-semibold">Éditeur du site</h2>
            <p>Nom de l'éditeur : O'Bad - Badminton Oissel Club</p>
            <p>Adresse : 1441 Av. du Général de Gaulle, 76350 OISSEL</p>
            <p>📧 Email : <a href="mailto:contact@mguardini.pro" className="text-blue-400 underline">contact@mguardini.pro</a></p>
  ...
  <p>Site : <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">vercel.com</a></p>
</section>
          ...
          <section className="mb-6 justify-start text-start">
            ...
            <p>🗒 Portfolio : <a href="https://www.mguardini.pro" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">www.mguardini.pro</a></p>
          </section>

          <section className="mb-6 justify-start">
            <h2 className="text-xl font-semibold">Propriété intellectuelle</h2>
            <p>
  L’ensemble des contenus présents sur ce site (textes, images, logos, graphismes, etc.) sont la propriété exclusive du O'Bad – Badminton Club de Oissel ou de ses partenaires, sauf mention contraire, et sont protégés par le droit d’auteur.
  <br /><br />
  Certaines images ou illustrations peuvent provenir de banques d’images libres de droit (ex. Unsplash, Pexels) et sont utilisées conformément à leurs conditions d'utilisation.
  Toute reproduction, modification ou diffusion des contenus sans autorisation écrite préalable est strictement interdite.
</p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p>Ce site ne collecte aucune donnée personnelle via formulaire ou compte utilisateur.</p>
